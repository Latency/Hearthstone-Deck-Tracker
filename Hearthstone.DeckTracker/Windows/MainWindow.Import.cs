...
namespace HearthStone.DeckTracker.Windows
{
	public partial class MainWindow
	{
		...
		private async Task<ImportingResult> ImportDeckFromUrl(string url = null, bool checkClipboard = true)
		{
			...
			var controller = await DialogManager.ShowProgressAsync(this, "Loading Deck", "Please wait...");
		...
		public async Task StartArenaImporting()
		{
			...
			if(!Core.Game.IsRunning)
			{
				...
				var result = await DialogManager.ShowMessageAsync(this, "Importing arena deck", "Start Hearthstone and enter the 'Arena' screen.",
				...
				controller = await DialogManager.ShowProgressAsync(this, "Importing arena deck", "Waiting for Hearthstone...", true);
			...
			{
				if(controller == null)
					controller = await DialogManager.ShowProgressAsync(this, "Importing arena deck", "", true);
			...
			if(existing != null)
			{
				var result = await DialogManager.ShowMessageAsync(this, "Deck already exists", "You seem to already have this deck.",
					MessageDialogStyle.AffirmativeAndNegative,
