...
namespace HearthStone.DeckTracker.Hearthstone.Entities
{
	[Serializable]
	public class Entity
	{
	...
	public class EntityInfo
	{
		...
		public CardMark CardMark
		{
			get
			{
				...
				if(_entity.CardId == HearthStone.Database.CardIds.NonCollectible.Neutral.TheCoin
					   || _entity.CardId == HearthStone.Database.CardIds.NonCollectible.Neutral.TradePrinceGallywix_GallywixsCoinToken)
