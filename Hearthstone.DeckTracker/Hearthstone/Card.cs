...
namespace HearthStone.DeckTracker.Hearthstone
{
	...
	{
		[NonSerialized]
		private HearthStone.Database.Card _dbCard;
		...
		[XmlIgnore]
		public bool IsPlayableHeroCard => Type == "Hero" && CardSet != HearthStone.Database.Enums.CardSet.CORE && CardSet != HearthStone.Database.Enums.CardSet.HERO_SKINS;
