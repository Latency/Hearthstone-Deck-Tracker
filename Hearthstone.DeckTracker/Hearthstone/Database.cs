	...
	public class Database
	{
		public static Card GetCardFromId(string cardId)
		{
			if(string.IsNullOrEmpty(cardId))
				return null;
			if(Cards.All.TryGetValue(cardId, out HearthStone.Database.Card dbCard))
		...
		public static Card UnknownCard => new Card(Cards.All[HearthStone.Database.CardIds.NonCollectible.Neutral.Noooooooooooo]);

		public static string UnknownCardId => HearthStone.Database.CardIds.NonCollectible.Neutral.Noooooooooooo;
	}
}
