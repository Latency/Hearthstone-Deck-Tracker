...
namespace HearthStone.DeckTracker.Hearthstone
{
	public class Player : INotifyPropertyChanged
	{
		...
		public bool HasCoin => Hand.Any(e => e.CardId == HearthStone.Database.CardIds.NonCollectible.Neutral.TheCoin);
		...
		public void Draw(Entity entity, int turn)
		{
			...
			if(!IsLocalPlayer)
			{
				if(_game.OpponentEntity?.GetTag(GameTag.MULLIGAN_STATE) == (int)HearthStone.Database.Enums.Mulligan.DEALING)
