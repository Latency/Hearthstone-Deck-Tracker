...
using HearthStone.DeckTracker.Controls.Stats.Arena;
using HearthStone.DeckTracker.Controls.Stats.Constructed;
...
namespace HearthStone.DeckTracker.Controls.Stats
{
	...
	public partial class Overview : UserControl
	{
		...
		{
		    if(!(TreeViewStats.SelectedItem is TreeViewItem selected))
				return;
