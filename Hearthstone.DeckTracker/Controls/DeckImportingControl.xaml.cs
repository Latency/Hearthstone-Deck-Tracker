...
namespace HearthStone.DeckTracker.Controls
{
	public partial class DeckImportingControl : INotifyPropertyChanged
	{
		...
		public Visibility TextVisibility => _ready ? Visibility.Collapsed : Visibility.Visible;
		public Visibility ContentVisibility => _ready ? Visibility.Visible : Visibility.Collapsed;
		public Visibility StartButtonVisibility => Core.Game.IsRunning ? Visibility.Collapsed : Visibility.Visible;
		public Visibility AutoImportingVisibility => _brawl || Config.Instance.ConstructedAutoImportNew ? Visibility.Collapsed : Visibility.Visible;
