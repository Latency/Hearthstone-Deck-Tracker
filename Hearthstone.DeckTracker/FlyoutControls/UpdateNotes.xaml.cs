...
using HearthStone.DeckTracker.Controls.Information;
...
namespace HearthStone.DeckTracker.FlyoutControls
{
	...
	public partial class UpdateNotes : INotifyPropertyChanged
	{
		...
		private string GetReleaseNotes()
		{
			...
			{
				string releaseNotes;
				using(var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("HearthStone.DeckTracker.Resources.CHANGELOG.md"))
		...
		private void ButtonClose_Click(object sender, RoutedEventArgs e)
		{
			if(_continueToHighlight)
			{
				...
				Core.MainWindow.FlyoutUpdateNotes.BeginAnimation(FrameworkElement.HeightProperty,
